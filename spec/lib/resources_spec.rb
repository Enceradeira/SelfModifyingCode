...
describe Resources do
  ...
  context 'when unlimited machine cycle available' do
    ...
    it 'called once' do
      expect(lambda { resources.consume_machine_cycle }).to_not raise_error
    end
    it 'called several times' do
      expect(lambda { 5.times { resources.consume_machine_cycle } }).to_not raise_error
    end
  end
  context 'when 1 machine cycles available' do
    ...
    describe 'consume_machine_cycle' do
      ...
      it 'called twice' do
        ...
        expect(lambda { resources.consume_machine_cycle }).to raise_error(ResourceExceededError)
      end
    end
  end
end